...
def download_file(base_path, file_name, date_range=None, folder=None):
    ...
    if os.path.exists(save_path):
        ...
        logger.log("file already exists! {}".format(save_path))
        return
    ...
    try:
        ...
        with open(save_path, 'wb') as out_file:
            ...
            logger.log("File Download: {}".format(save_path))
            while True:
        ...
        logger.log("File not found: {}".format(download_url))
        pass
...
def get_parser(parser_type):
    parser = ArgumentParser(description=("This is a script to download historical {} data").format(
